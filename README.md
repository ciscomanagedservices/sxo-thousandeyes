...
[![published](https://static.production.devnetcloud.com/codeexchange/assets/images/devnet-published.svg)](https://developer.cisco.com/codeexchange/github/repo/ciscomanagedservices/sxo-thousandeyes) [![sxoanalyzed](https://svgshare.com/i/_4q.svg)](https://github.com/ciscomanagedservices/sxo-analyzer)

Additional Resources: 

- API Docs: https://developer.thousandeyes.com/v6/
- BONUS: [ThousandEyes API v6 Swagger JSON Doc](/Cisco%20ThousandEyes%20API%20v6.json) 🎉
...
#### 2. [Get Test Details](/TE-GetTestDetails__definition_workflow_01P8WJT3O5873768U3UiQRXscSJNDklot45)
...
#### 3. [Query Agent ID](/TE-QueryAgentID__definition_workflow_01P9TCQUAG0DD5OYkfuXZ51Fp41xC2mRJi2)
...
#### 4. [Create Instant Test - SIP Server](/TE-CreateSIPInstantTest__definition_workflow_01P9KSGNAP67I2SqSGJ8iZb82MP34bcCpUc)
...
#### 5. [Create Instant Test - Agent to Server](/TE-CreateNetworkInstantTest__definition_workflow_01PA0SYZA23QH2AuC1VUrkF6l1d5hKzSQkB)
...
#### 6. [Rerun Instant Test](/TE-InstantTestRerun__definition_workflow_01P8Z4V1K7OOH37DF10BeSfL3f5JSRFTQKL)
...
#### 7. [Test Data: (Network) End-to-End Metrics](/TE-GetE2ENetworkMetrics__definition_workflow_01P8XWJZ16DLH0RHdFwycXiEGN2UqCkRcsA)
...
#### 8. [Test Data: (Network) Path Visualization](/TE-NetworkPathVisualisation__definition_workflow_01P9TL04P9X864dEp8yCSXvEcuzPdZSoMDf)
...
#### 9. [Test Data: (Network) Detailed Path Trace](/TE-GetDetailedNWPathTrace__definition_workflow_01PAQU6ZBFLHY1nL2kdW3FMq2ToSHGdfyVR)
...
#### 10. [Test Data: (Voice) SIP Server](/TE-SIPServerMetrics__definition_workflow_01P90GVPWL8F16DvqwofSVwGBOQMKWCxeV9)
...
#### 11. [Endpoint Test Data: (Network) End-to-End Metrics](/TE-GetE2EEndpointMetrics__definition_workflow_01PARTN8KKXYV5wkWa8qsJtPxcJtLzAkbE5)
...
#### 12. [Endpoint Test Data: (Network) Path Visualization](/TE-EndpointAgentNWPathVis__definition_workflow_01PARNVHLVALO7RQtBimWR4MgGHNpevqzcM)
...
#### 13. [Endpoint Test Data: (Network) Detailed Path Trace](/TE-EndpointAgentGetDetailedPathTrace__definition_workflow_01PARZE1PAOTG2qTw6VsxrqwPju7Urxi0cB)
